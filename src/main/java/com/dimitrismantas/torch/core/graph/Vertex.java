...
public final class Vertex extends Table {
  ...
  public Edge outgoingEdges(int j) { return outgoingEdges(new Edge(), j); }
  public Edge outgoingEdges(Edge obj, int j) { int o = __offset(18); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int outgoingEdgesLength() { int o = __offset(18); return o != 0 ? __vector_len(o) : 0; }
  public Edge.Vector outgoingEdgesVector() { return outgoingEdgesVector(new Edge.Vector()); }
  public Edge.Vector outgoingEdgesVector(Edge.Vector obj) { int o = __offset(18); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
