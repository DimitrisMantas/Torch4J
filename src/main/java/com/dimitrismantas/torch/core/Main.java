...
import static com.dimitrismantas.torch.core.graph.shortestpaths.OptimizationMode.MINIMUM_DISTANCE;
...
public class Main {
    public static void main(String[] args) {
        ...
        final GenericLabelSettingShortestPathAlgorithm ShortestPathAlgorithm = new GenericLabelSettingShortestPathAlgorithm(graph, reader1, reader2);
