...
public final class DeserializedVertex extends Table {
  ...
  public com.dimitrismantas.torch.core.utils.serialization.graph.DeserializedEdge outgoingEdges(int j) { return outgoingEdges(new com.dimitrismantas.torch.core.utils.serialization.graph.DeserializedEdge(), j); }
  public com.dimitrismantas.torch.core.utils.serialization.graph.DeserializedEdge outgoingEdges(com.dimitrismantas.torch.core.utils.serialization.graph.DeserializedEdge obj, int j) { int o = __offset(16); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int outgoingEdgesLength() { int o = __offset(16); return o != 0 ? __vector_len(o) : 0; }
  public com.dimitrismantas.torch.core.utils.serialization.graph.DeserializedEdge.Vector outgoingEdgesVector() { return outgoingEdgesVector(new com.dimitrismantas.torch.core.utils.serialization.graph.DeserializedEdge.Vector()); }
  public com.dimitrismantas.torch.core.utils.serialization.graph.DeserializedEdge.Vector outgoingEdgesVector(com.dimitrismantas.torch.core.utils.serialization.graph.DeserializedEdge.Vector obj) { int o = __offset(16); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
